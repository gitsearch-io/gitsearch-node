...
import io.gitsearch.search.setup.AbstractElasticsearchTest;
...
public class SearchServiceTest extends AbstractElasticsearchTest {
...
//        client = getClient();
//        searchService = new SearchService(ES_URL);
//
...
//        searchService.upsert(documentID, branch, filePath, content, url);
//
...
//        searchService.upsert(documentID, branch, filePath, content, url);
//        searchService.upsert(documentID, featureBranch, filePath, content, url);
//
//        GetResponse response = client.prepareGet(ES_INDEX, ES_TYPE, documentID + toBase64(url)).get();
//        List<Map<String, String>> fileBranches = parseFileBranches(response);
...
//
//        searchService.delete(documentID, branch, filePath, url);
//
...
//        insertDocument(documentID, content, fileBranches);
//
//        searchService.delete(documentID, featureBranch, filePath, url);
//
//        GetResponse response = client.prepareGet(ES_INDEX, ES_TYPE, documentID + toBase64(url)).get();
